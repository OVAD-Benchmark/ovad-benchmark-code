# Edited version from detic/modeling/roi_heads/res5_roi_heads.py
import inspect
import logging
import numpy as np
...
from .roi_emb_heads import EmbeddingRes5ROIHeads
...
class CustomRes5ROIHeads(EmbeddingRes5ROIHeads):
    """
    Customized version of Res5ROIHeads to include:
    - train with image labels
    - train with captions
    - addimage box
    - get top proposals
    """
...
@ROI_HEADS_REGISTRY.register()
class PhraseRes5ROIHeads(CustomRes5ROIHeads):
    def forward(
        self,
        images,
        features,
